...
public class TestClassContentGenerator implements JavaClassGenerator {
    ...
    private static final String DISABLE_SAME_SELECT_TYPES_WITH_DIFFERENT_PARAM_VALUES_ANNOT = "    "
    ...
    private static final String TEST_CLASS_TEMPLATE = JUNIT_5_TEST_ANNOT_IMPORT +
    ...
    private static final String TEXT_TEMPLATE_PART = JSON_ASSERT_ASSERTION +
            ASSERTJ_ASSERTION +
            "\n" +
            "    }\n" +
            "\n" +
    ...
    public static TestClassContentGenerator INSTANCE = new TestClassContentGenerator();

    TestClassContentGenerator() {
    }
